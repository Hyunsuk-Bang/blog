...
touch file
echo "subjectAltName=DNS:${SERVER_CN}" >> file
openssl x509 -req -extfile file -passin pass:1111 -sha256 -days 365 -in server.csr -CA ca.crt -CAkey ca.key -set_serial 01 -out server.crt 
